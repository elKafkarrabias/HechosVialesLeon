...
map.getView().fit([-11348889.629123, 2373998.968053, -11271600.065801, 2432975.153708], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Hechos viales en León</h2>';
        return titleElement;
    })(),
